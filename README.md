...
* understand and learn low level binary operations
* implement a binary API for big Integer math
...
# Team and workspace
* Developers: Elizaveta (neelrhyra) - team lead, Garegin_Karapetyan (howieter), Kseniya (biancara), Vladimir (warbirdo).
